...
void rtp_session_update_payload_type(RtpSession * session, i32 pt);
void rtp_putq(queue_t *q, mblk_t *mp);
mblk_t * rtp_getq(queue_t *q, u32 ts, i32 *rejected);
i32 rtp_session_rtp_recv(RtpSession * session, u32 ts);
i32 rtp_session_rtcp_recv(RtpSession * session);
i32 rtp_session_rtp_send (RtpSession * session, mblk_t * m);
i32 rtp_session_rtcp_send (RtpSession * session, mblk_t * m);
