...
void graphics_register_bitmap(rdpGraphics* pgraphics, rdpBitmap* bitmap)
{
	CopyMemory(pgraphics->Bitmap_Prototype, bitmap, sizeof(rdpBitmap));
}
...
/* static method */
void graphics_register_pointer(rdpGraphics* pgraphics, rdpPointer* pointer)
{
	CopyMemory(pgraphics->Pointer_Prototype, pointer, sizeof(rdpPointer));
}
...
void graphics_register_glyph(rdpGraphics* pgraphics, rdpGlyph* glyph)
{
	CopyMemory(pgraphics->Glyph_Prototype, glyph, sizeof(rdpGlyph));
}
