...
RFX_CONTEXT* rfx_context_new(BOOL encoder)
{
...
#ifdef _WIN32
	{
		...
		verinfo.dwBuildNumber = 0;
		verinfo.dwPlatformId = VER_PLATFORM_WIN32_NT;
		ZeroMemory(verinfo.szCSDVersion, sizeof(verinfo.szCSDVersion));

		if (verinfo.dwOSVersionInfoSize == sizeof(OSVERSIONINFOEXA))
		{
			LPOSVERSIONINFOEXA lpVersionInformationEx = (LPOSVERSIONINFOEXA)&verinfo;
