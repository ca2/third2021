...
config.h.element to config.h, and edit the macro definitions to be the way you
...
such macros are listed as a commented #undef in config.h.element. Macros such
