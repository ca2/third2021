...
void ntlm_get_version_info(NTLM_VERSION_INFO* versionInfo)
{
	...
	ZeroMemory(osVersionInfo.szCSDVersion, sizeof(osVersionInfo.szCSDVersion));

	if (osVersionInfo.dwOSVersionInfoSize == sizeof(OSVERSIONINFOEXA))
	{
		LPOSVERSIONINFOEXA lpVersionInformationEx = (LPOSVERSIONINFOEXA)&osVersionInfo;
